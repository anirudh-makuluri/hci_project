...
import 'package:project1/chat/components/chat_bubble.dart';
import 'package:project1/chat/components/chat_detail_page_appbar.dart';
import 'package:project1/chat/models/chat_message.dart';
import 'package:project1/chat/models/send_menu_items.dart';
...
class _ChatDetailPageState extends State<ChatDetailPage> {
  List<ChatMessage> chatMessage = [
    ChatMessage(message: "Hi Vamsi", type: MessageType.Receiver),
    ChatMessage(message: "Hope you are doin good", type: MessageType.Receiver),
    ChatMessage(message: "Hello Amit, I'm good what about you", type: MessageType.Sender),
